...
class Program640
{
    public static void main(String Arg[])
    {
      ...
      mobj.DeleteFrom(2);
      mobj.DeleteFrom("Aishwarya Bhalerao");
...
//delete from employee where eid = 3;
    ...
    public void DeleteFrom(String Name)
    {
        ...
        if(bFlag == false)
        {
            System.out.println("Unable to delete elements from database as given name is not present!");
    ...
    public void AggregateSum()
    {
        ...
        System.out.println("Sumation of salary is: "+iSum);
    }
